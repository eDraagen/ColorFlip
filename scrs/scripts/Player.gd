...
func _ready():
	$"/root/EventsAutoload".connect("finish_flag_collide_with_player", self, "_camera_stop")
	$deathcollider_green.connect("body_entered", self, "_on_deathCollider_body_entered")
	$deathcollider_red.connect("body_entered", self, "_on_deathCollider_body_entered")
	$deathcollider_blue.connect("body_entered", self, "_on_deathCollider_body_entered")
	$deathcollider_yellow.connect("body_entered", self, "_on_deathCollider_body_entered")
